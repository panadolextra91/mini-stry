          ...
          zones: [
            {
              ...
              message:
                "Cross-module deep imports forbidden. Import from '@/modules/directory' (barrel) instead — Module Boundary Rule (D-08).",
            },
            {
              ...
              message:
                "Cross-module deep imports forbidden. Import from '@/modules/policy' (barrel) instead — Module Boundary Rule (D-08).",
            },
            {
              target: "./src/modules/!(audit)/**/*",
              from: "./src/modules/audit/{domain,application,adapters}/**/*",
              message:
                "Cross-module deep imports forbidden. Import from '@/modules/audit' (barrel) instead — Module Boundary Rule (D-08).",
            },
            {
              target: "./src/modules/!(runtime)/**/*",
              from: "./src/modules/runtime/{domain,application,adapters}/**/*",
              message:
                "Cross-module deep imports forbidden. Import from '@/modules/runtime' (barrel) instead — Module Boundary Rule (D-08).",
            },
            {
              ...
              message:
                "Cross-module deep imports forbidden. Import from '@/modules/request' (barrel) instead — Module Boundary Rule (D-08).",
            },
            {
              ...
              message:
                "Cross-module deep imports forbidden. Import from '@/modules/approval' (barrel) instead — Module Boundary Rule (D-08).",
            },
            {
            ...
            },
            {
              ...
              message:
                "convex/ may not import domain entities directly. Use module barrel to access service types only.",
            },
            {
              target: "./convex/**/*",
              from: [
                "./src/modules/*/application/**/*",
                "./src/modules/*/domain/!(ids).ts",
                "./src/modules/*/domain/!(ids)/**/*",
              ],
              message:
                "convex/ handlers must import services, contexts, and error types through @/modules/<mod> barrel. Adapter implementations (./adapters/convex/**) may still be deep-imported for DI wiring.",
            },
          ],
        },
      ],
